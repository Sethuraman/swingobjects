 ...
 * to the java servlet request scope. You would use this object to store data that needs
...
public class RequestScopeObject {
	 ...
	 * Call the method {@link RequestScopeObject#getNewRequestObj()} instead
	 * 
	 */
	private RequestScopeObject(){
	...
	public void puObjectInMap(String key,Object obj){
		requestMap.put(key,obj);
	}
	
	public RequestScopeObject getNewRequestObj(){
		RequestScopeObject scopeObj=new RequestScopeObject();
		REQUEST_SCOPE.add(scopeObj);
		return scopeObj;
	}
	
	public RequestScopeObject endOfRequest(){
		return REQUEST_SCOPE.pop();
	}
	
	public RequestScopeObject getRequestObj(){
